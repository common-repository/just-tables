		...
		\CSF::createSection( $metabox_slug, array(
			...
			'fields' => array(
				...
				array(
					...
					'type'     => 'switcher',
					'title'    => esc_html__( 'Added to cart notice', 'just-tables' ),
					'subtitle' => esc_html__( 'Show or hide added to cart notice.', 'just-tables' ),
					'default'  => true,
				),
				...
				array(
					...
					'type'     => 'switcher',
					'title'    => esc_html__( 'Paginate scroll to top', 'just-tables' ),
					'subtitle' => esc_html__( 'Enable or disable paginate scroll to top.', 'just-tables' ),
					'default'  => true,
					'class'    => 'pro-field',
				),
