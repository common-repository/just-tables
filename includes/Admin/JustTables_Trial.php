 ...
 * Class.
 */
if ( ! class_exists( 'JustTables_Trial' ) ) {
    final class JustTables_Trial {
        ...
        public function __construct() {
            ...
            $this->prefix = 'justtables';
            $this->pro_file = 'just-tables-pro/just-tables-pro.php';
            $this->data_center = 'https://feed.hasthemes.com/just-tables/tw/';
            $this->initial_page = admin_url( 'edit.php?post_type=jt-product-table' );
            $this->screen_ids =  array('edit-jt-product-table', 'jt-product-table');
