...
;( function ( $ ) {
    ...
    $( document ).ready( function () {
         ...
         * @since 1.0.0
         */
        $( document ).on( 'change', '.jt-product-table-columns', function () {
            ...
            $.each( columns, function () {
                var thisColumn = $( this ),
                    ...
                    authorColumnAddElements = thisColumn.find( '.csf-field.author-add-elements' ),
                ...
                if ( 'author' !== columnId ) {
                    authorColumnAddElements.remove();
                }
         ...
         * @since 1.0.0
         */
        $( document ).on( 'click', '.jt-product-table-design .csf-accordion-title', function () {
            var thisTitle = $( this ),
         ...
         * @since 1.0.0
         */
        $( '.csf-field.pro-field,.csf-field.custom-width,.csf-field.horizontal-align,.csf-field.title-add-elements,.csf-field.author-add-elements,.csf-field.action-add-elements,.pro-column .csf-cloneable-content' ).click( function () {
